...
Welcome to [Lexi](<[Lexi](https://github.com/Guylaban/FACET)>) repository! We're excited that you're interested in contributing. Please take a moment to review this document to ensure a smooth collaboration process.
...
- please make sure it was not asked before here [issues](https://github.com/Guylaban/FACET/issues).
- make sure it is not work in progress here [pull requests](https://github.com/Guylaban/FACET/pulls).
- you can then [create an issue](https://github.com/Guylaban/FACET/issues/new/choose) with the following information:
...
Thank you for contributing to [Lexi](https://github.com/Guylaban/FACET) dont forget to give us a :star: !